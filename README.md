...
# Data Analytics Portfolio | Marco Fernando Caputo
Welcome to my portfolio. I am a student focused on Data Analytics, and this space showcases
the main practical projects i developed during my training path with **Start2Impact**.
...
### Big Data Integration & Digital Transformation Strategy

* **Business Objective:** Analyze how a medium-sized Italian transportation company can strategically integrate Big Data systems
into its production processes to improve operational efficiency, faster innovation, and gain a competitive market advantage.
...
### Business Case: Welfare Analytics

* **Business Objective:** Analyze and optimize the operational and financial data of an italian conceptual startup.
...
### Personal Growth & Meditation Activity Manager with Python 

* **Business Context** MeditActive is a Python-based system designed to help users track, organize, and analyze personal growth activities such as meditation sessions,
  physical exercises, mindfulness challenges, and sustainable actions.The project simulates the core logic of an app built by a fictional wellness company whose mission
  is to make meditation accessible and support users in achieving daily, monthly, and yearly goals. Self-awareness is often overshadowed by productivity.

* **Tools:** The project is built entirely in Python using dictionaries, lists, and modular functions.
  It leverages datetime.date for automatic timestamps and collections.Counter for statistical aggregation.
  Development and testing were carried out in Jupyter Notebook, using an in‑memory data structure to simulate the app’s backend logic.

* **Core activities** I built a compact Python system that manages user activities through a structured dictionary-based model
  and a registration workflow that prevents duplicates. I implemented a search function capable of matching multiple attributes
  and an advanced filtering module that combines duration, frequency, reward levels, and temporal goals.
  The project also includes a statistical component that summarizes user behavior
